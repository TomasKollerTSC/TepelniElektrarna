...
import { TABS, LABELS, TITLES, TAB_PHOTOS, PHOTO_SOURCES, GENERAL_TEXT, CONTENT, tabPhoto, OVERVIEW_PHOTO, OVERVIEW_SOURCE } from './Texts';
...
['CZ', 'EN', 'DE'].forEach(l => { new Image().src = `/f/10/Gen_${l}.jpg`; });
