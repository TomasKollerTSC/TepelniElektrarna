...
```
cd existing_repo
git remote add origin https://gitlab.techmania.cz/techmania-science-center/exponaty/energetika/tepelna-elektrarna.git
git branch -M main
...
* [Set up project integrations](https://gitlab.techmania.cz/techmania-science-center/exponaty/energetika/tepelna-elektrarna/-/settings/integrations)
